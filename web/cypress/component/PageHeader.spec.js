...
describe('PageHeader component', () => {
    const baseCss = '/__root/src/assets/styles/global.css' // diretório: web/src/assets/styles/global.css
    const indexCss = '/__root/src/component/PageHeader/styles.css' // diretório: web/src/component/PageHeader/styles.css
    it('componente deve ser renderizado com sucesso', () => {
        ...
        mount(
            ...
            ,
            {
                stylesheets: [baseCss, indexCss] //referenciar os arquivos de estilo dentro do método mount.
            }
        )
        
        // métodos avançados de busca do cypress: find e children
